...
<div class="col-lg-6 col-12 mt-2 mt-lg-4">
  <a href="<?=Url::to(['top/index',"slug"=>$post_name]);?>" class="top-banners top-banners-hovr p-3 text-center position-relative align-items-center d-flex" style="background-image: url(<?=$image?>);" href="#">
