...
?>
<img class="d-lg-none" src="/img/Gloatme_f_white.png">
      ...
      <nav class="navbar navbar-expand-lg py-2 py-lg-2 navbar-header">
         ...
         <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link px-lg-4 py-3 py-lg-2 text-white" href="<?=Url::to(['site/signup']);?>"><i class="fa fa-heart mr-1"></i>SignUp</a>
               </li>   
               <?PHP endif;?>   
               <?php if (!Yii::$app->user->isGuest):?>
               <li class="nav-item">
